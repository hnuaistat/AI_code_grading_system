...
AVAILABLE_MODELS = [
    ...
    {"id": "fireworks/deepseek-v3p2", "label": "deepseek-v3.2", "provider": "fireworks"},
    {"id": "fireworks/kimi-k2-instruct", "label": "kimi-k2", "provider": "fireworks"},
    {"id": "fireworks/qwen3p5-35b-a3b", "label": "qwen3.5-35b", "provider": "fireworks"},
]
